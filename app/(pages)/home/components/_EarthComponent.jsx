...
import { planetVariants, titleVariants } from "@/lib/framerVariants";
      ...
      <AspectRatio ratio={2 / 1}>
        <div className="flex w-full h-full max-md:flexMid max-md:mx-auto">
          <div className="flex items-start justify-start h-full basis-2/5 max-md:absolute max-md:inset-0 ">
            <motion.div
              className="relative w-full md:scale-125 md:translate-x-[12.5%] min-w-[300px] max-md:w-[80vw] max-md:mx-auto"
              initial={planetVariants.initialState}
              animate={planetVariants.finalState}
            >
              <Earth />
            </motion.div>
          </div>
          <motion.div
            className="z-20 mx-0 flexMid max-md:mx-auto max-md:flex-col max-md:basis-3/5 max-md:w-screen"
            initial={titleVariants.initialState}
            animate={titleVariants.finalState}
          >
