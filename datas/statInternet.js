export const statInternet = [
    {
        id : 10,
        qtt : "67 %",
        text : "c'est le nombre de TPE/PME qui ont un site internet.",
        explain :"Même si ce nombre croît depuis 2011, nous sommes toujours en dessous de la moyenne européenne. et vous ? Faites vous partie de ces 67% qui ont compris les enjeux du numérique ? Nos modes de consommation ont changé, et vous ?" 
    },
    {
        id : 15,
        qtt : "95 %",
        text : "c'est le nombre de TPE/PME qui estiment que leur présence en ligne est indispensable !",
        explain :"Cet écart entre la prise de conscience et la présence en ligne est multifactorielle.<br> Le coût ? La complexité ? La maintenance ? <br>Mais vous résolvez des problèmes pour les autres ! C'est la raison d'être de votre entreprise, non ?<br> Alors laissez quelqu'un d'autre résoudre votre problème et vous accompagner. 😉 "
    },
    {
        id : 20,
        qtt : "59 %",
    ...
    },
    {
        id : 30,
        qtt : "80 %",
        text : "4 consommateurs / 5 recherchent en ligne avant de faire affaire physiquement.",
        explain :"En fonction de votre business, votre site peut être statique (coaching, prestations intellectuelles comme les avocats, les notaires..) ou dynamique (vente en ligne, réservation en ligne, prise de rendez-vous en ligne).<br> Quel que soit votre business, vous n'avez besoin pas d'un site internet, vous avez besoin de VOTRE site internet. "
    },
    {
        id : 40,
        qtt : "1h46",
